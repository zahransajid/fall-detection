...
class Fall_model(nn.Module):
    def __init__(self, in_channels, kernel_size, num_filters, pool_size):
        ...
        self.fc1 = nn.Linear(int(num_filters*2)*46, int(num_filters//2)*46)
        self.relul = nn.ReLU()
        self.fc2 = nn.Linear(int(num_filters//2)*46, 3)
...
if __name__ == '__main__':
    model = Fall_model(in_channels=8,kernel_size=(3),num_filters=4,pool_size=8)
